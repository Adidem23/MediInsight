...
doctor.post("/addPresc", (req, res) => {

    const patientID = req.body.patientID;
    const PatientPresc = req.body.prec;

    console.log(patientID);
    console.log(PatientPresc);

    const patient = `UPDATE patient SET prescription='${PatientPresc}' WHERE patient_id=${patientID};`
    ...
    form.parse(req, async (error, fields, files) => {
        ...
        function fileToGenerativePart(path, mimeType) {
          ...
          async function run() {
            ...
            const prompt = "Diagnose the disease shown in the provided image and extract related parameters for further analysis";
          ...
          const UpdatedResponse=Response.toString();
