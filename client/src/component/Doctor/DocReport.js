...
const DocReport = () => {
    ...
    return (
        <>
            <br />
            <h2 style={{ display: 'block', margin: 'auto', width: 'fit-content' }}>Upload Patient Image </h2>
            <br />
            ...
            <div style={{ width: 'fit-content', margin: 'auto' }} >
                ...
                </label> : <img height={"200px"} width={"200px"} src={TempImgURL} alt='No Image Found' />}
                ...
                {ResponseText &&
                    <>
                        <p>Genrated Report is : </p>
                        <div style={{margin:'auto',width:'1000px' ,margin:'2px solid red'}}>
                            <p>{ResponseText}</p>
                        </div>
                    </>
                }
